...
Test ONU Upgrade Correct Indication of Download Abort
    ...
    [Tags]    functional   ONUUpgradeDownloadAbort    notready
...
#        Wait Until Keyword Succeeds    ${timeout}    2s    Verify ONU Device Image Status    ${image_version}
#        ...    ${onu_device_id}    DOWNLOAD_FAILED    CANCELLED_ON_REQUEST    IMAGE_DOWNLOADING
...
Restart And Check BBSIM
    ...
    Restart Pods By Label    ${namespace}    ${label_key}    ${bbsim_label_value}
    Sleep    5s
