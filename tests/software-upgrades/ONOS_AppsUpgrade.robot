...
Test ONOS App Minor Version Upgrade
    ...
    ...    Requirement: OAR file name needs to be in format: <app-name>-<app-version>.oar
    ...
    FOR    ${I}    IN RANGE    0    ${num_apps_under_test}
        ${app}    Evaluate    ${onos_apps_under_test}[${I}].get("app")
        ${version}    Evaluate    ${onos_apps_under_test}[${I}].get("version")
        ...
        ...    ${CURDIR}/../../tests/data/onos-files/${app}-${version}.oar
