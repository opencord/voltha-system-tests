...
Get Inventory Data
    ...
    FOR     ${component}    IN  @{dm_components}
        ...
        ...   utility.check_Inventory_Element  @{inventory}  ${component['description']}
        ...   ${component['name']}  ${component['data_type']}
        ...   ELSE  Run Keyword     utility.check_Inventory_Element    @{inventory}
...
Get Configurable Component Inventory Info
    ...
    END
    ${hwComInfoReq}=    Evaluate    {'device_uuid':${suite_device_uuid}, 'component_uuid':${uuid_hw1},
    ...   'component_name':'${name_hw1}'}
    ...
    ${hwComInfoReq}=    Evaluate    {'device_uuid':${suite_device_uuid}, 'component_uuid':${uuid_hw2},
    ...  'component_name':'${name_hw2}'}
    ${hwComInfoRes}=     dmi1.Hw Management Service Get Hw Component Info    ${hwComInfoReq}
    ${hwComInfoRes}=    Get From List    ${hwComInfoRes}   0
    ${status}=     Get From Dictionary  ${hwComInfoRes}     status
    Should Be Equal    ${status}    OK_STATUS
    ...
    ${HWCompSetReq}=    Evaluate    {'device_uuid':${suite_device_uuid}, 'component_uuid':${uuid_hw1},
    ...  'component_name':'${name_hw1}', 'changes':${suite_device_name}}
