...
Dummy Test
    ...
    Log     Dummy Test
    ${val}    Set Variable    300
    ${seconds}=    Validate Time Unit    ${val}
    Log    seconds = ${seconds}    console=yes
    ${val}=    Validate Time Unit    ${seconds}    False
    Log    number = ${val}    console=yes
    ${min}    Set Variable    5min
    ${seconds}=    Validate Time Unit    ${min}
    Log    seconds (5min) = ${seconds}    console=yes
    Log    ${METRIC_DICT}
