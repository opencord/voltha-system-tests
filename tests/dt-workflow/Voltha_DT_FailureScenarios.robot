...
Verify ONU after Rebooting Physically for DT
    ...
    [Tags]    functionalDt    PowerSwitchOnuRebootDt    VOL-2819
    [Setup]    Run Keywords    Announce Message    START TEST RebootOnu_PowerSwitch_Dt
    ...        AND             Start Logging    RebootOnu_PowerSwitch_Dt
    [Teardown]    Run Keywords    Collect Logs
    ...           AND             Stop Logging    RebootOnu_PowerSwitch_Dt
    ...           AND             Announce Message    END TEST RebootOnu_PowerSwitch_Dt
...
Verify OLT after Rebooting Physically for DT
    ...
    [Setup]    Run Keywords    Announce Message    START TEST RebootOlt_Physical_Dt
    ...        AND             Start Logging    RebootOlt_Physical_Dt
    [Teardown]    Run Keywords    Collect Logs
    ...           AND             Stop Logging    RebootOlt_Physical_Dt
    ...           AND             Announce Message    END TEST RebootOlt_Physical_Dt
    ...           AND             Delete Device and Verify
    # Add OLT device
    Setup
    # Performing Sanity Test to make sure subscribers are all AUTH+DHCP and pingable
