...
Test Subscriber Delete and Add for DT
    ...
    ...    Disable and Enable the ONU (This is to mock the existing DT behaviour)
    ...    Re-add the subscriber, and validate that the pings are successful
    [Tags]    functionalDt    SubAddDelete    bbsim    released
    ...
    FOR    ${I}    IN RANGE    0    ${num_onus}
        ...
        ...    ${onu_device_id}    0
        # Disable and Re-Enable the ONU (To mock DT current workflow)
