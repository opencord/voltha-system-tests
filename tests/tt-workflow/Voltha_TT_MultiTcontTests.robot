...
Test that the BW is limited to GIR
    ...
    ${test_onu}=    Set Variable    ${multi_tcont_tests.test1[0]}
    ...
    FOR    ${I}    IN RANGE    0    ${num_all_onus}
        ...
        Continue For Loop If    '${onu}' != ${test_onu_sn} or '${service_type}' != ${test_service_type}
        ...
        ...    '${onu}' == ${test_onu_sn} and '${service_type}' == ${test_service_type} and ${us_bw} == ${test_us_bw_profile}
        ...    True    False
