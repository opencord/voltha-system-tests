...
Check Mib Audit
    ...
    FOR    ${I}    IN RANGE     ${MDS_MISMATCHES_PER_ONU}
        Set Wrong MDS Counter All ONUs   ${NAMESPACE}
        ${list_onu_device_id}    Create List
        Build ONU Device Id List    ${list_onu_device_id}
        Run Keyword And Continue On Failure    Wait Until Keyword Succeeds    ${interval}    5s
        ...    Validate MIB Audits All ONUs    ${list_onu_device_id}
        kafka.Records Clear
