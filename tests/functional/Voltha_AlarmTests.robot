...
Test RaiseActivationFailureAlarm
    ...
    [Tags]    active
    ${header}    ${deviceEvent}    Raise Alarm And Get Event    ActivationFailure     ${onu_sn}    ONU_ACTIVATION_FAIL_RAISE_EVENT
...
Test RaiseDriftOfWindowAlarm
    ...
    [Tags]    active
    ${header}    ${deviceEvent}    Raise Alarm And Get Event    DriftOfWindow     ${onu_sn}    ONU_DRIFT_OF_WINDOW_RAISE_EVENT
    # Note: PON is the zero value of the subCategory field, and causes it to be not present
...
Test ClearDriftOfWindowAlarm
    ...
    [Tags]    active
    ${header}    ${deviceEvent}    Clear Alarm And Get Event    DriftOfWindow     ${onu_sn}    ONU_DRIFT_OF_WINDOW_CLEAR_EVENT
    # Note: PON is the zero value of the subCategory field, and causes it to be not present
    Verify Header   ${header}    Voltha.openolt.ONU_DRIFT_OF_WINDOW\.(\\d+)    ${EMPTY}
...
Test RaiseDyingGaspAlarm
    ...
    [Tags]    active
    ${header}    ${deviceEvent}    Raise Alarm And Get Event    DyingGasp     ${onu_sn}    ONU_DYING_GASP_RAISE_EVENT
    # Note: PON is the zero value of the subCategory field, and causes it to be not present
...
Test ClearDyingGaspAlarm
    ...
    [Tags]    active
    ${header}    ${deviceEvent}    Clear Alarm And Get Event    DyingGasp     ${onu_sn}    ONU_DYING_GASP_CLEAR_EVENT
    # Note: PON is the zero value of the subCategory field, and causes it to be not present
    Verify Header   ${header}    Voltha.openolt.ONU_DYING_GASP\.(\\d+)    ${EMPTY}
...
Test RaiseLopcMissAlarm
    ...
    [Tags]    active
    ${header}    ${deviceEvent}    Raise Alarm And Get Event    LOPC_MISS     ${onu_sn}    ONU_LOPC_MISS_RAISE_EVENT
    # Note: PON is the zero value of the subCategory field, and causes it to be not present
...
Test ClearLopcMissAlarm
    ...
    [Tags]    active
    ${header}    ${deviceEvent}    Clear Alarm And Get Event    LOPC_MISS     ${onu_sn}    ONU_LOPC_MISS_CLEAR_EVENT
    # Note: PON is the zero value of the subCategory field, and causes it to be not present
    Verify Header   ${header}    Voltha.openolt.ONU_LOPC_MISS\.(\\d+)    ONU
...
Test RaiseLopcMicErrorAlarm
    [Documentation]    Raise LOPC_MISS Alarm and verify event received
    [Tags]    active
    ${header}    ${deviceEvent}    Raise Alarm And Get Event    LOPC_MIC_ERROR     ${onu_sn}    ONU_LOPC_MIC_ERROR_RAISE_EVENT
    # Note: PON is the zero value of the subCategory field, and causes it to be not present
...
Test ClearLopcMicErrorAlarm
    [Documentation]    Clear LOPC_MISS Alarm and verify event received
    [Tags]    active
    ${header}    ${deviceEvent}    Clear Alarm And Get Event    LOPC_MIC_ERROR     ${onu_sn}    ONU_LOPC_MIC_ERROR_CLEAR_EVENT
    # Note: PON is the zero value of the subCategory field, and causes it to be not present
    Verify Header   ${header}    Voltha.openolt.ONU_LOPC_MIC_ERROR\.(\\d+)    ONU
...
Test RaiseLossOfBurstAlarm
    ...
    [Tags]    active
    ${header}    ${deviceEvent}    Raise Alarm And Get Event    LossOfBurst     ${onu_sn}    ONU_LOSS_OF_BURST_RAISE_EVENT
...
Test ClearLossOfBurstAlarm
    ...
    [Tags]    active
    ${header}    ${deviceEvent}     Clear Alarm And Get Event     LossOfBurst    ${onu_sn}    ONU_LOSS_OF_BURST_CLEAR_EVENT
    Verify Header   ${header}    Voltha.openolt.ONU_LOSS_OF_BURST\.(\\d+)    ONU
...
Test RaiseLossOfFrameAlarm
    ...
    [Tags]    active
    ${header}    ${deviceEvent}    Raise Alarm And Get Event    LossOfFrame     ${onu_sn}    ONU_LOSS_OF_FRAME_RAISE_EVENT
...
Test ClearLossOfFrameAlarm
    ...
    [Tags]    active
    ${header}    ${deviceEvent}     Clear Alarm And Get Event     LossOfFrame    ${onu_sn}    ONU_LOSS_OF_FRAME_CLEAR_EVENT
    Verify Header   ${header}    Voltha.openolt.ONU_LOSS_OF_FRAME\.(\\d+)    ONU
