...
ETCD Failure Test
    ...
    Wait Until Keyword Succeeds    ${timeout}    2s
    ...    Pod Is Ready By Label    ${namespace}    ${common_pod_label_key}    ${rwcore_pod_label_value}
    Wait Until Keyword Succeeds    ${timeout}    2s
    ...    Pod Is Ready By Label    ${namespace}    ${common_pod_label_key}    ${ofagent_pod_label_value}
    Wait Until Keyword Succeeds    ${timeout}    2s
    ...    Pod Is Ready By Label    ${namespace}    ${common_pod_label_key}    ${adapter_openolt_pod_label_value}
