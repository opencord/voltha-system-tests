...
Clear All Devices Then Create New Device
    ...
    Run Keyword If    ${count} != 0    Disable All Devices In Voltha
    Run Keyword If    ${count} != 0    Wait Until Keyword Succeeds    ${timeout}    2s    Test All Devices Disabled In Voltha
    Run Keyword If    ${count} != 0    Delete All Devices In Voltha
    Run Keyword If    ${count} != 0    Wait Until Keyword Succeeds    ${timeout}    2s    Test Empty Device List
    ...
    Run Keyword If    ${count} != 0 and ${has_dataplane}    Wait Until Keyword Succeeds    600s    5s
