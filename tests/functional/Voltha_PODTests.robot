...
Setup Suite
    ...
    Run Keyword Unless    '${setup}' == 'bbsim'    Import Resource    ../../../cord-tester/src/test/cord-api/Framework/Subscriber.robot
    Run Keyword Unless    '${setup}' == 'bbsim'    Import Resource    ../../../cord-tester/src/test/cord-api/Framework/OLT.robot
    Run Keyword Unless    '${setup}' == 'bbsim'    Import Resource    ../../../cord-tester/src/test/cord-api/Framework/DHCP.robot
    Run Keyword Unless    '${setup}' == 'bbsim'    Import Resource    ../../../cord-tester/src/test/cord-api/Framework/Kubernetes.robot
