...
Sanity E2E Test for OLT/ONU on POD
    ...
    FOR    ${I}    IN RANGE    0    ${num_onus}
        ...
        Wait Until Keyword Succeeds    ${timeout}    2s    Verify Number of AAA-Users    ${k8s_node_ip}
        ...    ${ONOS_SSH_PORT}     ${num_onus}
        ...
        ...    ${dst0['ip']}    ${dst0['user']}    ${dst0['pass']}    ${dst0['container_type']}
        ...    ${dst0['container_name']}
        Wait Until Keyword Succeeds    ${timeout}    2s    Validate DHCP Allocations    ${k8s_node_ip}
        ...    ${ONOS_SSH_PORT}     ${num_onus}
    END
