...
#${KUBERNETES_CONFIGS_DIR}    ${KUBERNETES_CONFIGS_DIR}/${POD_NAME}.confPowered by Gerrit Code Review (2.14.5.1) | New UI | Press '?' to view keyboard shortcuts
