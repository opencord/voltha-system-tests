...
Test ONU Delete and Auto-Discovery
    ...
    #TODO: VOL-3097: BBSim Support
    [Tags]    functional    VOL-3098    ONUDelete
    [Setup]    Run Keywords    Start Logging    ONUDelete
    ...        AND             Setup
    [Teardown]    Run Keywords    Collect Logs
    ...           AND             Stop Logging    ONUDelete
    ...           AND             Delete Device and Verify
