...
Sanity E2E Test for OLT/ONU on POD With Core Fail and Restart
    ...
    FOR    ${I}    IN RANGE    0    ${num_onus}
        ...
        Wait Until Keyword Succeeds    ${timeout}    2s    Does Deployment Have Replicas    voltha    voltha-rw-core    0
        Sleep    30s    "Just wasting time ..."
        Scale K8s Deployment    voltha    voltha-rw-core    1
        Wait Until Keyword Succeeds    ${timeout}    2s    Does Deployment Have Replicas    voltha    voltha-rw-core    1
        Restart VOLTHA Port Foward    voltha-api-minimal
        Wait Until Keyword Succeeds    ${timeout}    2s    Does Deployment Have Replicas    voltha    voltha-ofagent    1
        Sleep    60s    "Just wasting time ..."
