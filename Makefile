...
bbsim-multi-uni-errorscenarios-att: ROBOT_MISC_ARGS += -X $(ROBOT_DEBUG_LOG_OPT)
bbsim-multi-uni-errorscenarios-att: ROBOT_FILE := Voltha_ErrorScenarios.robot
bbsim-multi-uni-errorscenarios-att: ROBOT_CONFIG_FILE := $(ROBOT_SANITY_MULTI_UNI_SINGLE_PON_FILE)
bbsim-multi-uni-errorscenarios-att: voltha-test
...
bbsim-multi-uni-failurescenarios-att: ROBOT_MISC_ARGS += -X $(ROBOT_DEBUG_LOG_OPT) -e PowerSwitch -e PhysicalOLTReboot
bbsim-multi-uni-failurescenarios-att: ROBOT_FILE := Voltha_FailureScenarios.robot
bbsim-multi-uni-failurescenarios-att: ROBOT_CONFIG_FILE := $(ROBOT_SANITY_MULTI_UNI_SINGLE_PON_FILE)
bbsim-multi-uni-failurescenarios-att: voltha-test
