...
memory-leak-tests: ROBOT_MISC_ARGS += -i functionalMemoryLeak $(ROBOT_DEBUG_LOG_OPT)
memory-leak-tests: ROBOT_FILE := VOLTHA_Memory_Leak_Tests.robot
memory-leak-tests: voltha-memory-leak-test
