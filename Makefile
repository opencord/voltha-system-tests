...
voltha-bbsim-test: $(venv-patched)
	$(activate) \
	  && cd tests/bbsim \
...
voltha-pm-data-test: $(venv-patched)
	$(activate) \
	  && tests/pm-data \
...
software-upgrade-test: $(venv-patched)
	$(activate) \
...
# -----------------------------------------------------------------------
vst_venv        : venv-patched
venv-patched    : $(venv-patched)
$(venv-patched) : $(venv-activate-script)
...
help ::
	@echo '  venv-patched           Create and patch a virtual env'
