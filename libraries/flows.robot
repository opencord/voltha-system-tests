...
Calculate Tt flows
    ...
    ...     Evaluate     0
    ${flow_count}=  Run Keyword If  $provisioned=='false'
    ...     Evaluate    (${olt_count} * ${dhcpFlowsCount}) + (${olt_count} * ${lldpFlowsCount}) + (${olt_count} * ${igmpFlowsCount})
    ...     ELSE
    ...     Evaluate    (${uni_count} * 15) + (${olt_count} * ${dhcpFlowsCount}) + (${olt_count} * ${lldpFlowsCount}) + (${olt_count} * ${igmpFlowsCount})
    Return From Keyword     ${flow_count}