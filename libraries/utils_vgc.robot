...
Delete All Devices and Verify
    ...
    FOR    ${I}    IN RANGE    0    ${length}
        ...
        #${olt_serial_number}=    Set Variable    ${list_olts}[${I}][sn]
        Wait Until Keyword Succeeds    ${timeout}    5s
        ...    Validate Deleted Device Cleanup In VGC    ${ONOS_SSH_IP}    ${ONOS_SSH_PORT}    ${olt_serial_number}    ${device_id}
        ...    ${maclearning_enabled}
    END
    Wait Until Keyword Succeeds    ${timeout}    5s    Validate Cleanup In ETCD    ${INFRA_DT_NAMESPACE}
...
Delete Device and Verify
    ...
    ...    Validate Deleted Device Cleanup In VGC    ${ONOS_SSH_IP}    ${ONOS_SSH_PORT}    ${olt_serial_number}    ${olt_device_id}
