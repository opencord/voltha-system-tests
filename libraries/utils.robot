...
AlphaONURestoreDefault
    ...
    ${output}=    Wait Until Keyword Succeeds    ${timeout}    15s
    ...    Login And Run Command On Remote System    sudo ifconfig ${onu_ifname} 192.168.1.3/24
    ...
    ${output}=    Wait Until Keyword Succeeds    ${timeout}    15s
    ...    Login And Run Command On Remote System    ${cmd}
    ...    ${rg_ip}    ${rg_user}    ${rg_pass}    ${container_type}    ${container_name}
    Log To Console    ${output}
    ${output}=    Wait Until Keyword Succeeds    ${timeout}    15s
    ...    Login And Run Command On Remote System    sudo ifconfig ${onu_ifname} 0
    ...    ${rg_ip}    ${rg_user}    ${rg_pass}    ${container_type}    ${container_name}
