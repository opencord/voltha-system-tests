...
Check For Error Logs in Pod Type1 Given the Log Output
    ...
    [Documentation]    To check if there are any errors in the pods of type 1 mentioned in ../variables/variable.robot file
    Log    ${logOutput}
...
Check For Error Logs in Pod Type2 Given the Log Output
    ...
    [Documentation]    To check if there are any errors in the pods of type 2
    Log    ${logOutput}
...
Get Container Dictionary
    [Documentation]    To create a dictionary of pod name and container name
    ...    eg. radius:radius-5646467f88-4p7rt
