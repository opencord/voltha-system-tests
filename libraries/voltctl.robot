...
Assert ONUs in Voltha
    ...
    ...     kubectl exec -it $(kubectl get pods --all-namespaces | grep "kafkacat" | awk '{print $2}') -- kafkacat -b cord-kafka -C -t ${kafkaEventTopic} | python ../tests/scale/onu-detection.py ${count}
    Should Be Equal As Integers    ${rc1}    0
