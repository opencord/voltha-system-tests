...
Check for ONUs in Voltha
    ...
    ...     kubectl exec -it $(kubectl get pods --all-namespaces | grep "kafkacat" | awk '{print $2}') -- kafkacat -b kafka -C -t ${kafkaBBSimTopic} | python ../tests/scale/onu-detection.py ${count}
    Should Be Equal As Integers    ${rc1}    0
