...
Validate Raised Timestamp
    ...
    # ${raisedTs} looks like '2021-04-28 06:56:54.000000', convert it to seconds of epoch
    ${raisedTs}=    Convert Date    ${raisedTs}    result_format=epoch    exclude_millis=yes
    Run Keyword And Continue On Failure    Should Be Equal    ${raisedTs}    ${kpiEvent2Ts}
