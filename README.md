...
* `tests/` - Test Directories that are categoriesed. Test cases should be grouped together with common testing purposes. Eg. sanity, functionality, controlplane, dataplane, failover, scale, etc. 
...
2. Run Test-Suites
    * eg. `robot -V tests/data/voltha_minimal_k8_resources.yaml tests/sanity/sanity.robot`
