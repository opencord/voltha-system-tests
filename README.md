...
├── tests
  ...
  └── openonu-go-adapter/   // tests state for ONU Go adapter with different operator workflows
...
The `make sanity-single-kind` target, for ATT, is a shortcut that specifies a number of variables
used by the tests:
