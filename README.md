...
for the test are written in .yaml file. Instead of hardcoding
the POD specific variables in the test case, it relies on a separate configuration file which
describes the POD setup. The `.yaml` file contains details like the ONUs, OLT, nodes etc.
